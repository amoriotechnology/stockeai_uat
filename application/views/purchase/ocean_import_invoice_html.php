               ...
               <div class="document">
                  <div class="spreadSheetGroup">
                     ...
                     <table class="shipToFrom">
                        <thead >
                           <tr>
                              <th class="col-md-6"> Shiper: {supplier_name} <br></th>
                      ...
                      <table class="shipToFrom">
                        <thead >
                           <tr>
                              <td class="col-md-6">Consignee:<br> {consignee}<br> </td>
                      ...
                      <table class="shipToFrom maeask">
                        <thead >
                           <tr>
                              <td class="col-md-3 " > <p><em>Vessel</em> <br>{vessel}</p> <p><em>Voyage No</em><br>{voyage_no}</p></td>
                     <td class="col-md-3" > <p><em>Port of Loading</em> <br>{port_of_loading}</p><p><em>Port of Discharge</em><br>{port_of_discharge}</p></td>
