                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('User/company_insert');?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="1" class="form-control" name="company_name" id="company_name" placeholder="Enter your Companyname" required  value="<?php echo $company_info[0]['company_name']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="1" class="form-control" name="email" id="email" required value="<?php echo $company_info[0]['company_name']; ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" tabindex="1" class="form-control"
                                   value="<?php echo $company_info[0]['mobile']; ?>"   
                                 name="mobile" id="mobile" required placeholder="Enter your mobile" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $company_info[0]['mobile']; ?>"  
                                 class="form-control" name="address" id="address" placeholder="Enter your address" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                class="form-control" name="website" id="website" placeholder="Enter your website" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input required type="text" tabindex="1" class="form-control" 
                                value="<?php echo $company_info[0]['mobile']; ?>"  
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo $company_info[0]['mobile']; ?>"   tabindex="4" ramji="" class="form-control" id="password" required name="password" placeholder="<?php echo display('password') ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $user_info[0]['email']; ?>"  
                                 tabindex="1" class="form-control" name="user_email" required id="user_email" placeholder="Enter your useremail" />
                            </div>
                        </div>
